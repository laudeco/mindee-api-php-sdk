 ...
 */
class TotalTax1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Total_Tax_1';
    ...
    */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling TotalTax1., must be smaller than or equal to 1.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling TotalTax1., must be bigger than or equal to 0.');
        }
     ...
     * Sets value
     *
     * @param float|null $value The total amount of taxes.
     *
     * @return self
     */
