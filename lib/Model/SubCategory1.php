...
/**
 * SubCategory1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubCategory1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sub_Category_1';
    ...
    public const VALUE_PLANE = 'plane';
    public const VALUE_TAXI = 'taxi';
    public const VALUE_TRAIN = 'train';
    public const VALUE_RESTAURANT = 'restaurant';
    public const VALUE_SHOPPING = 'shopping';
    ...
    */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling SubCategory1., must be smaller than or equal to 1.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling SubCategory1., must be bigger than or equal to 0.');
        }
     ...
     * Sets value
     *
     * @param string|null $value The invoice or receipt sub category among 5 predefined classes for transport and food.
     *
     * @return self
     */
