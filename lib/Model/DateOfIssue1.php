...
/**
 * DateOfIssue1 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DateOfIssue1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Date_of_issue_1';
    ...
    */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling DateOfIssue1., must be smaller than or equal to 1.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling DateOfIssue1., must be bigger than or equal to 0.');
        }
     ...
     * Sets value
     *
     * @param \DateTime|null $value ISO date yyyy-mm-dd. Works both for European and US dates.
     *
     * @return self
     */
