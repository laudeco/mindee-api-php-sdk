 ...
 */
class TaxesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Taxes_inner';
    ...
    */
     ...
     * Sets base
     *
     * @param float|null $base The tax base.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code The tax code.
     *
     * @return self
     */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling TaxesInner., must be smaller than or equal to 1.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling TaxesInner., must be bigger than or equal to 0.');
        }
     ...
     * Sets rate
     *
     * @param float|null $rate The tax rate in percentage.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param float|null $value The tax amount.
     *
     * @return self
     */
