 ...
 */
class TotalAmountIncludingTaxesTipsFeesAndOtherCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Total_Amount_including_taxes__tips__fees_and_other_charges_';
    ...
    */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling TotalAmountIncludingTaxesTipsFeesAndOtherCharges., must be smaller than or equal to 1.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling TotalAmountIncludingTaxesTipsFeesAndOtherCharges., must be bigger than or equal to 0.');
        }
