...
/**
 * TotalNetOfTaxesFeesAndDiscount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TotalNetOfTaxesFeesAndDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Total_net_of_taxes__fees_and_discount';
    ...
    */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling TotalNetOfTaxesFeesAndDiscount., must be smaller than or equal to 1.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling TotalNetOfTaxesFeesAndDiscount., must be bigger than or equal to 0.');
        }
