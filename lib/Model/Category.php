...
class Category implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling Category., must be smaller than or equal to 1.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling Category., must be bigger than or equal to 0.');
        }
