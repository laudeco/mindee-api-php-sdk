...
/**
 * ReferenceNumbersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReferenceNumbersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Reference_Numbers_inner';
    ...
    */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling ReferenceNumbersInner., must be smaller than or equal to 1.');
        }
        if (($confidence < 0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling ReferenceNumbersInner., must be bigger than or equal to 0.');
        }
     ...
     * Sets value
     *
     * @param string|null $value List of Reference numbers including PO number.
     *
     * @return self
     */
